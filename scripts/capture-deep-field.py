...
Four images, and every one of them says where it came from:
...
EXTRA_POSE = 0.68
# The constellation the strip follows: the first Worlds beat, which is the one
# Round 1 wired to a real key image.
STRIP_CHAPTER = 'world-ask-repos'
